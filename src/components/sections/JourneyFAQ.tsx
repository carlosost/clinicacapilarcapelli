...
export function JourneyFAQ() {
  ...
  return (
    <motion.section id="jornada" className="bg-cream pt-16 pb-24 lg:pt-20 lg:pb-32 md:h-screen md:snap-start md:flex md:flex-col md:justify-center md:overflow-hidden">
